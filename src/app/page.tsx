import { LeftSideBar, ButtonPrime, Tweet } from "@/components";
  ...
  return (
    <div className="w-full h-full flex justify-center items-center bg-black">
      <div className="max-w-screen-xl w-full h-full flex relative">
        <LeftSideBar />
        <section className="ml-[275px] flex w-full max-w-[600px] h-full min-h-screen flex-col border-x-2 border-x-gray-700/60">
